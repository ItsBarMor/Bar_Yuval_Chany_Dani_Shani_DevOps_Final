...
public class DevopsStressFromHar extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("Stress Test Scenario")
    .exec(
      http("Submit Form")
...

  {
    setUp(
      scn.injectOpen(
        ...
        rampUsersPerSec(100).to(250).during(Duration.ofMinutes(1)),
        constantUsersPerSec(250).during(Duration.ofMinutes(1))
      )
